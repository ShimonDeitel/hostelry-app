...
final class HostelryUITests: XCTestCase {
    ...
    func testAddEntryFlow() {
        ...
        let field1 = app.textFields["field_placeName"]
    ...
    func testFreeLimitTriggersPaywall() {
        ...
        XCTAssertTrue(app.buttons["paywallPurchaseButton"].waitForExistence(timeout: 2) || app.staticTexts["Hostelry Pro"].waitForExistence(timeout: 2))
    }
